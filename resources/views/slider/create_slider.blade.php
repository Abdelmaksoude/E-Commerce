...
@section('content')
    <div class="live-preview">
        <form class="row g-3" action="{{ route('admin_sliders.stpre') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="validationDefault01" name="title_en" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text"  class="form-control" id="validationDefault02" name="description_en" required>
            </div>
            <div class="col-12">
