<ul class="navbar-nav" id="navbar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">{{ trans('all_trans.Dashboard') }}</span>
        </a>
        <div class="collapse menu-dropdown" id="sidebarDashboards">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link" data-key="t-crm"> {{ trans('all_trans.Dashboard') }} </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('all_admins') }}" class="nav-link" data-key="t-analytics"> Admins </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin_sliders.index') }}" class="nav-link" data-key="t-ecommerce"> Sliders </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('brand.index') }}" class="nav-link" data-key="t-crypto"> Brands </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('index_category') }}" class="nav-link" data-key="t-projects"> Categories </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('sub_category.index') }}" class="nav-link" data-key="t-nft"> Sub Category</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('side_service.index') }}" class="nav-link" data-key="t-job">Side Service</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('products.index') }}" class="nav-link" data-key="t-job">Products</a>
                </li>
                @if(App\Models\SiteSetting::count() == 0)
                    <li class="nav-item">
                        <a href="{{ route('siteSettings.create') }}" class="nav-link" data-key="t-job">Site Setting</a>
                    </li>
                @else
                    <li class="nav-item">
                        <a href="{{ route('siteSettings.edit') }}" class="nav-link" data-key="t-job">Edit Setting</a>
                    </li>
                @endif
                <li class="nav-item">
                    <a href="{{ route('order.index') }}" class="nav-link" data-key="t-job">Orders</a>
                </li>
            </ul>
        </div>
