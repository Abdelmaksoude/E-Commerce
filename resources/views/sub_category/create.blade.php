...
@section('content')
    <div class="live-preview">
        <form class="row g-3" action="{{ route('sub_category.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-md-4">
            ...
            @enderror
            <div class="col-md-4">
                <label for="validationDefault01" class="form-label">Name Arabic</label>
                <input type="text" class="form-control" id="validationDefault01" name="ar[name]" >
            </div>
            <div class="col-md-4">
                <label for="validationDefault01" class="form-label">Name English</label>
