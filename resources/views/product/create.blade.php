    ...
    <div class="live-preview">
        <form class="row g-3" action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="validationDefault01" name="ar[title]" >
            </div>
            <div class="col-md-4">
                <label for="validationDefault01" class="form-label">Title English</label>
                <input type="text" class="form-control" id="validationDefault01" name="en[title]" >
            </div>
            @error('title')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            ...
            <div class="col-md-4">
                ...
                <input type="text"  class="form-control" id="validationDefault02" name="rate" >
            </div>
            <div class="col-md-4">
